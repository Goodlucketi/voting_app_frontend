                    ...
                    <div className="works">
                        ...
                        <ul>
                            <li className="my-2 shadow-md bg-slate-50/50 p-6">
                                ...
                                <p className=" text-lg">Use your NIN and BVN to verify your identity and access the voting system.</p>
                            </li>
                            <li className="my-2 shadow-md bg-slate-50/50 p-6">
                            ...
                            <li className="my-2 shadow-md bg-slate-50/50 p-6">
                                ...
                                <p className=" text-lg">Confirm your selection and cast your vote with confidence.</p>
                            </li>
                            <li className="my-2 shadow-md bg-slate-50/50 p-6">
                                ...
                                <p className=" text-lg">Access history of previous elections and votes.</p>
                            </li>
                            <li className="my-2 shadow-md bg-slate-50/50 p-6">
                                ...
                                <p className=" text-lg">Access real-time election results once voting ends.</p>
                            </li>
