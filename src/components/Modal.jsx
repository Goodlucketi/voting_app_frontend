...
const Modal = ({modal, setModal, confirmVote, cancelVote, selectedParty})=>{
    ...
    return (
        <div className="modal fixed h-screen top-0 w-full left-0 bg-slate-50/95 shadow-md p-4 z-10">
            <div className="modal-content text-center absolute top-[20%] rounded-md shadow-lg p-6 left-3 md:left-[35%]">
                ...
                <img src={selectedParty.candidatesLogo} alt="" className="p-2 w-5/12 mx-auto"/>
                <p className="text-xl">Are you sure you want to Vote <span className="text-red-700 font-bold text-2xl">{selectedParty.candidateParty}</span></p>
