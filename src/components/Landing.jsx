        ...
        <header className="md:py-2 md:w-11/12 mx-auto">
            <main className="md:grid md:grid-cols-2 items-center h-screen md:h-92 overflow-hidden mx-auto py-10">
                <div className="text md:relative md:text-left p-4 rounded-xl mb-5">
                    ...
                    <p className="text-slate-900 p-2 md:text-xl">Simple, Secure and Transparent Voting starts with<Link className="text-green-700 text-xl font-bold underline rounded-lg shadow-md" to="/authentication"> iVote</Link></p>
                </div>
                <div className="image">
